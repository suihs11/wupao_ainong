...
public class CustomPopupWindow {
	...
	public void showDropDown(int xOffset, int yOffset) {
		...
		window.setAnimationStyle(com.ainong.launcher.R.style.Animations_PopDownMenu);
	...
	public void showLikeQuickAction(int xOffset, int yOffset) {
		...
		window.setAnimationStyle(com.ainong.launcher.R.style.Animations_PopUpMenu_Center);
		...
		if (rootHeight > anchorRect.top) {
			...
			window.setAnimationStyle(com.ainong.launcher.R.style.Animations_PopDownMenu_Center);
		}
