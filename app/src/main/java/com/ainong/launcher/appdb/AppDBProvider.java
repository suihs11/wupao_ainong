package com.ainong.launcher.appdb;
...
import com.ainong.launcher.LauncherProvider;

public class AppDBProvider extends ContentProvider {
	static final String AUTHORITY = "com.ainong.launcher.appdb";
                	...
                	if (paths.size() == 3) {
                		...
                		try {
                			...
                			db.execSQL("UPDATE "+AppDB.APPINFOS+" SET "+
            						AppDB.AppInfos.LAUNCH_COUNT + "=" + AppDB.AppInfos.LAUNCH_COUNT + " + 1, " +
            						AppDB.AppInfos.LAST_LAUNCHED + " = "+ curUnixTime +
            						" WHERE substr("+ AppDB.AppInfos.COMPONENT_NAME + ",1,"+ cPathName.length() +") = ?",
