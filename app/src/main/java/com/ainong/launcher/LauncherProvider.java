...
public class LauncherProvider extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.ainong.launcher.settings";
    ...
    private static class DatabaseHelper extends SQLiteOpenHelper {
        ...
        private boolean updateContactsShortcuts(SQLiteDatabase db) {
            ...
            try {
                ...
                c = db.query(TABLE_FAVORITES, new String[] { LauncherSettings.Favorites._ID, LauncherSettings.Favorites.INTENT },
        ...
        private boolean addUriShortcut(SQLiteDatabase db, ContentValues values,
            ...
            intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
            values.put(LauncherSettings.Favorites.INTENT, intent.toUri(0));
            values.put(LauncherSettings.Favorites.TITLE, r.getString(titleResId));
            values.put(LauncherSettings.Favorites.ITEM_TYPE, LauncherSettings.Favorites.ITEM_TYPE_SHORTCUT);
            values.put(LauncherSettings.Favorites.SPANX, 1);
            values.put(LauncherSettings.Favorites.SPANY, 1);
            ...
            values.put(LauncherSettings.Favorites.ICON_RESOURCE, r.getResourceName(iconResId));
