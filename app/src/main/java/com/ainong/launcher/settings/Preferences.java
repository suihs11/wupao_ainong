...
import com.ainong.launcher.IconCache;
import com.ainong.launcher.IconItemInfo;
import com.ainong.launcher.Launcher;
import com.ainong.launcher.ShortcutInfo;
...
public class Preferences implements OnSharedPreferenceChangeListener {
	...
	public void setLauncher(Launcher launcher) {
		if (launcher == null && mPreferences != null) {
			...
			PreferenceManager.setDefaultValues(launcher, com.ainong.launcher.R.xml.settings, false);
		}
		mLauncher = launcher;
	}
