...
import com.ainong.launcher.Launcher;
import com.ainong.launcher.settings.SettingsActivity;
...
public class DefaultAction implements LauncherActions.Action {
	...
	public static DefaultAction getAction(Launcher launcher, int action) {
		...
		switch(action) {
			case ACTION_OPENCLOSE_DRAWER:
				name = launcher.getString(com.ainong.launcher.R.string.action_opendrawer); break;
			case ACTION_SHOW_ADW_SETTINGS:
				name = launcher.getString(com.ainong.launcher.R.string.action_adw_settings); break;
			case ACTION_SHOW_NOTIFICATIONS:
				name = launcher.getString(com.ainong.launcher.R.string.menu_notifications); break;
			case ACTION_MANAGE_APPS:
				name = launcher.getString(com.ainong.launcher.R.string.menu_manage_apps); break;
			case ACTION_SYSTEM_SETTINGS:
				name = launcher.getString(com.ainong.launcher.R.string.menu_settings); break;
			default:
				name = "";
		}
		if (!name.equals(""))
	...
	public int getIconResourceId() {
		switch(mBindingValue) {
			...
			case ACTION_SHOW_NOTIFICATIONS:
				return com.ainong.launcher.R.drawable.ic_menu_notifications;
			case ACTION_SYSTEM_SETTINGS:
				return android.R.drawable.ic_menu_preferences;
			default:
				return com.ainong.launcher.R.drawable.ic_launcher_home;
		}
	}
